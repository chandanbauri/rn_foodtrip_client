    ...
    ordered_concerns: [
      {
        ...
        description: `You are not lawfully entitled to use Adda Food App in the country in which you are located or reside. If you are not of legal age to bind agreement with us.
        `,
      },
      {
        feild_title: 'If any change made to Terms & Conditions:',
        description: `Adda Food team can modify Terms & conditions at any time, in sole discretion. If Adda Food team will be modifying any content, team will let you know either through app. You do agree a major factor to modified Terms & conditions. If you do not agree to be bound by the modified Terms, then you cannot use the services any more. Over Services are evolving over time we can change or close any services at any time without any notice, at our sole discretion.`,
      },
      {
        feild_title: 'Privacy:',
    ...
    un_ordered_concerns: [
      {
        ...
        description: `Do not use Adda Food to promote any illegal activities.`,
      },
      {
        feild_title: 'Harmful Activities',
        description: `Do not distribute content that harms or interferes with the operation of the networks, Servers, or other infrastructure of Adda Food.`,
      },
      {
